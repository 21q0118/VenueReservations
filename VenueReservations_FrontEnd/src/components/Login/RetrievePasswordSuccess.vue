<template>
  <div>
    ...
    <div class="right">
      <div class="login">
        <el-text class="loginfont" style="font-family: 'MiSans'">找回成功</el-text>
        <div class="photo">
          <img class="gifphoto" src="../../assets/successful.gif">
        </div>
        <div class="loginbutton">
          <el-button color="#c05f6c" style="width: 100px;font-family: 'MiSans';"
                     @click="returnHome">返回主页
          </el-button>
        </div>
      </div>
    </div>
