  ...
  <div>
    <el-container class="layout-container">
      ...
      <el-footer style="height: auto;background: rgb(250,250,250);padding: 0;z-index: 8">
        ...
        <div>
          <el-form style="margin-top: 10px;padding: 20px; text-align: center;">
            <el-form-item size="large" style="display: inline-block">
              <el-input v-model="seform.co" placeholder="输入查询场馆" style="width: 800px" />
            <el-button style="margin-left: 30px" type="success" @click="searchsta">确定</el-button>
            </el-form-item>
          </el-form>
        </div>
...
axios.get('/api/abc/superManager/getAllStadiumInf', {
  params: {
